...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="<?= url_to('Jabatan::update', $jabatan['id_jabatan']) ?>" method="post">
                <div class="form-group row mb-2">
                    <label for="nama_jabatan" class="col-sm-2 col-form-label">Nama Jabatan</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" placeholder="Nama Jabatan" value="<?= $jabatan['nama_jabatan'] ?>">
                    </div>
                </div>
